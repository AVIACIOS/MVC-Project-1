...
<?= (isset($_GET['error_password'])
    ? "<div class='alert-danger'>Пароли не совпали!</div>"
    : "")
?>
    <div class="container">
        <div class="row">
                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="login" class="form-control" id="inputLogin"
                               placeholder="Укажите логин:" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="inputPasswordConfirmed" class="form-label">Повторите пароль:</label>
                        <input type="password" name="password_confirmed" class="form-control"
                               id="inputPasswordConfirmed" placeholder="Укажите пароль повторно:" required>
                    </div>
